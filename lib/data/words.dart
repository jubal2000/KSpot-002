...
class Words extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'ko_KR': {
      ...
      'Enable': '활성화',
      'Disable': '비활성화',
      'Enable spot?': '장소을 활성화 하시겠습니까?',
      'Disable spot?': '장소을 비활성화 하시겠습니까?',
      'Enable story?': '스토리를 활성화 하시겠습니까?',
      'Disable story?': '스토리를 비활성화 하시겠습니까?',
      'Show recommend?': '추천을 공개 하시겠습니까?',
      'Hide recommend?': '추천을 비공개 하시겠습니까?',
      ...
      'Invite chatting': '채팅초대',

      'This event has expired': '기간이 종료된 이벤트입니다',
      'This recommended event has expired': '기간이 종료된 후원입니다',
      'Please change the period\nin the \'Event edit\'': '\'이벤트 수정\'에서 기간을\n변경해 주세요',
      'No more list': '마지막 목록입니다',
      'Event recommend': '이벤트 추천',
      'Target event': '대상 이벤트',
      'Would you like to recommend a target event?': '대상 이벤트를 추천하시겠습니까?',
      'Show': '공개',
      'Hide': '비공개',
      'complete': '완료',
      ...
      'SPOT GROUP ADD': '장소 그룹 추가',
      'Spot Group Title *': '장소 그룹 이름 *',
      ...
      'MY FOLLOW LIST': '내 팔로워 목록',
      'MY BOOKMARK LIST': '내 북마크 목록',
      'BOOKMARK LIST': '북마크 목록',
      'MY RECOMMENDED LIST': '내 추천 목록',
      'MY PROMOTION LIST': '내 광고 목록',
      'Holding credits:': '보유 크레딧:',
      'Remaining after use:': '사용후 남은 크레딧:',
      'period': '기간',
      'Use credits': '사용 크레딧',
      'Event Recommend Success': '이벤트 추천 완료',
      'Event Recommend Failed': '이벤트 추천 실패',
      '1day': '1일',
      ...
      'NAME': '이름',
      'Please check length': '입력값 길이를 확인해 주세요',
      ...
      'MOBILE': '전화번호',
      'Mobile number verify': '전화번호 확인',
      'Send mobile verify error': '전화번호 인증 발송 실패',
      'Mobile number verify error': '전화번호 인증 실패',
      'Mobile number already in use': '이미 사용중인 전화번호입니다',
      'Mobile number is not valid': '잘못된 전화번호입니다',
      ...
      'Need mobile number verify': '전화번호 인증이 필요합니다',
      'Mobile change completed': '전화번호 변경 완료',
      ...
      'Create a new spot group': '새로운 장소그룹을 추가합니다',
      'Duplicate groups can be merged with other groups later': '중복된 그룹일경우 추후에 다른 그룹과 합쳐질수 있습니다',
      'Create a new spot': '새로운 장소을 추가합니다',
      'If you are not the actual owner of the spot, the owner may be forcibly changed later': '해당 장소의 실제 소유자가 아닐경우, 추후 소유자가 강제변경 될 수 있습니다',
