                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 5),
                      if (!mobileValidated)...[
                        Text('Need phone verify'.tr, style: ItemDescAlertStyle(context)),
                        SizedBox(height: 10),
                      ],
                      Container(
                        ...
                        child: VerifyPhoneWidget(
                          ...
                          isSignIn: false,
                          isValidated: editUserInfo!.mobileVerifyTime.isNotEmpty,
                          onCheckComplete: (_) {
                            // unFocusAll(context);
                            setState(() {
                              mobileValidated = true;
                              editUserInfo!.mobileVerifyTime = CURRENT_TEXT_TIME();
